...
interface Role {
  ...
  satinalma_siparisi_sil?: boolean;
}
                        ...
                        <div className="mt-3 bg-white rounded-lg shadow p-4 animate-fadeIn" onClick={(e) => e.stopPropagation()}>
                          ...
                          <div className="mb-6 border-b pb-4">
                            ...
                            <div className="space-y-3">
                              ...
                              {/* Satınalma Siparişi Silme İzni */}
                              <div className="flex items-center justify-between p-3 rounded border border-gray-200 bg-gray-50">
                                <div>
                                  <h4 className="text-sm font-medium text-gray-800">Satınalma Siparişi Silme</h4>
                                  <p className="text-xs text-gray-500 mt-1">Satınalma Siparişleri sayfasında sipariş kayıtlarını silebilir</p>
                                </div>
                                <label className="relative inline-flex items-center cursor-pointer">
                                  <input 
                                    type="checkbox" 
                                    className="sr-only peer"
                                    checked={role.satinalma_siparisi_sil || false}
                                    onChange={(e) => handleUpdateRolOzellik(role.id, 'satinalma_siparisi_sil', e.target.checked)}
                                  />
                                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                </label>
                              </div>
